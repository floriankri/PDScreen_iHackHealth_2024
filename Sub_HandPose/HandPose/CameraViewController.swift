...
class CameraViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //drawOverlay.backgroundColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 0).cgColor
        drawOverlay.strokeColor = #colorLiteral(red: 0.9399145246, green: 0.5029009581, blue: 0.2750358284, alpha: 1).cgColor
